...
:root {
  --background: #0a0f1a;
  --foreground: #ffffff;
  --card: rgba(15, 25, 45, 0.7);
  --card-foreground: #ffffff;
  --popover: rgba(15, 25, 45, 0.9);
  --popover-foreground: #ffffff;
  --primary: #00d4ff;
  --primary-foreground: #0a0f1a;
  --secondary: rgba(30, 45, 70, 0.6);
  --secondary-foreground: #ffffff;
  --muted: rgba(30, 45, 70, 0.4);
  --muted-foreground: #8892a6;
  --accent: #ff6b9d;
  --accent-foreground: #ffffff;
  --destructive: #ff4757;
  --destructive-foreground: #ffffff;
  --border: rgba(0, 212, 255, 0.2);
  --input: rgba(20, 35, 60, 0.8);
  --ring: #00d4ff;
  --chart-1: #00d4ff;
  --chart-2: #00ff88;
  --chart-3: #ff6b9d;
...
.glow-pink {
  box-shadow: 0 0 20px rgba(255, 107, 157, 0.4), 0 0 40px rgba(255, 107, 157, 0.2);
}
